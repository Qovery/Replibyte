...
:::tip New in v0.11.0
✨ **Major Performance Improvements**: SIMD optimizations, lock-free memory pools, and streaming architecture deliver 2-4x faster processing with 70-90% less memory overhead.
:::
