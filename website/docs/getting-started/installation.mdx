...
code [here](https://github.com/Qovery/replibyte/src/telemetry.rs). This can be deactivated at any time, and any data that has already been collected can be deleted on
